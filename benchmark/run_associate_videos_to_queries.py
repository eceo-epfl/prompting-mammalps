...
def get_parsing_function(prompt):
    if prompt == "An animal engaged in any activity other than foraging.":
        ...
        def check_file(video_id):
            individual_tracks = get_tracks_from_file_id(video_id)
            return check_tracks_contain_action(
        ...
        def check_file(video_id):
            ...
            return check_tracks_contain_action(
                roe_deer_tracks, action_name=Action.GRAZING
            )
        ...
        def check_file(video_id):
            individual_tracks = get_tracks_from_file_id(video_id)
            return check_tracks_contain_action(
                individual_tracks, action_name=Action.BROWSING
            )
        ...
        def check_file(video_id):
            ...
            return check_tracks_contain_activity(
        ...
        def check_file(video_id):
            ...
            return check_tracks_contain_deer_age(
                cam_reaction_tracks,
                age=DAge.ADULT,
                deer_species=Species.ROE_DEER,
            )
        ...
        def check_file(video_id):
            ...
            return check_tracks_contain_adult_deer_sex(
                cam_reaction_tracks,
                sex=DSex.MALE,
                deer_species=Species.RED_DEER,
            )
        ...
        def check_file(video_id):
            ...
            return check_tracks_contain_action(
                male_courtship_tracks,
                action_name=Action.TROTTING_OR_RUNNING,
            ) and check_tracks_contain_action(
                female_courtship_tracks,
                action_name=Action.TROTTING_OR_RUNNING,
            )
        ...
        def check_file(video_id):
            ...
            return check_tracks_contain_action(fox_tracks, action_name=Action.SNIFFING)
        ...
        def check_file(video_id):
            ...
            return check_tracks_contain_species(
        ...
        def check_file(video_id):
            ...
            return check_tracks_contain_action(
                adult_red_deer, action_name=Action.BROWSING
            )
        ...
        def check_file(video_id):
            ...
            return check_tracks_contain_activity(
                hare_tracks, activity_name=Activity.FORAGING
            )
        ...
        def check_file(video_id):
            ...
            return check_tracks_contain_activity(
                wolf_tracks, activity_name=Activity.FORAGING
            )
        ...
        def check_file(video_id):
            ...
            return check_tracks_contain_action(
                red_deer_tracks, action_name=Action.BROWSING
            )
        ...
        def check_file(video_id):
            ...
            return check_tracks_contain_action(
                individual_tracks, action_name=Action.DRINKING
            )
        ...
        def check_file(video_id):
            ...
            ) and check_tracks_contain_activity(
